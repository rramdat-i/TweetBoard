...
(function (factory) {
  ...
  $.fn.tweet = function (o) {
    var s = $.extend({
      ...
      template: "{avatar}{screen_name}{join} {text} {time}",  // [string or function] template used to construct each tweet <li> - see code for available vars
    ...
    function render_tweets(widget, tweets) {
      ...
      list.append($.map(tweets, function (o) { return o.listItemStart + t(s.template, o) + o.listItemEnd; }).join('')).
